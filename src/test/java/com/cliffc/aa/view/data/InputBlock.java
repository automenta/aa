...
public class InputBlock {
    ...
    public boolean equals(Object o) {
        ...
        if ((!(o instanceof InputBlock))) return false;
        ...
        for (InputBlock succ : successors) s.add(succ.name);

        for (InputBlock succ : b.successors) if (!s.contains(succ.name)) return false;
