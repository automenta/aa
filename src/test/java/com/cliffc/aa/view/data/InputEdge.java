...
public class InputEdge {
    ...
    private InputEdge(char fromIndex, char toIndex, int from, int to, String label, String type) {
    ...
    private static final WeakHashMap<InputEdge, WeakReference<InputEdge>> immutableCache = new WeakHashMap<>();
    ...
    private InputEdge(char fromIndex, char toIndex, int from, int to, String label, String type, State state) {
        this.toIndex = toIndex;
        this.fromIndex = fromIndex;
        this.from = from;
        this.to = to;
