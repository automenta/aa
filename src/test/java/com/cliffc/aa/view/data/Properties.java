...
public class Properties implements Serializable, Iterable<Property> {
    ...
    private Properties(String name, String value) {
        this();
        this.setProperty(name, value);
    }

    private Properties(String name, String value, String name1, String value1) {
        this(name, value);
    ...
    static class PropertyCache {
        static final WeakHashMap<SharedProperties, WeakReference<SharedProperties>> immutableCache = new WeakHashMap<>();
    ...
    public static class RegexpPropertyMatcher implements PropertyMatcher {
        ...
        RegexpPropertyMatcher(String name, String value, int flags) {
    ...
    void setPropertyInternal(String name, String value) {
        for (int i = 0; i < map.length; i += 2) {
