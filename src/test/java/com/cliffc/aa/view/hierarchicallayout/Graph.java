...
public class Graph<N, E> {
    ...
    private Collection<Edge<N, E>> getEdges() {
        return Collections.unmodifiableCollection(edges.values());
    }

    private Collection<Node<N, E>> getNodes() {
    ...
    class DFSTraversalVisitor {

        void visitNode(Node<N, E> n) {
        }

        boolean visitEdge(Edge<N, E> e, boolean backEdge) {
            return true;
        }
    }

    class BFSTraversalVisitor {
    ...
    private List<Node<N, E>> getNodesWithInDegree(int x, boolean countSelfLoops) {
    ...
    private void traverseDFS(Collection<Node<N, E>> startingNodes, DFSTraversalVisitor tv) {
