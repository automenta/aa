...
public class LayoutGraph {
    ...
    private Set<Port> getInputPorts(Vertex v) {
        return this.inputPorts.get(v);
    }

    private Set<Port> getOutputPorts(Vertex v) {
        return this.outputPorts.get(v);
    }

    private Set<Link> getPortLinks(Port p) {
    ...
    private Set<Vertex> findRootVertices(Set<Vertex> startingRoots) {
        ...
        assert tmpVertices.isEmpty() || !result.isEmpty();
        return result;
    }
