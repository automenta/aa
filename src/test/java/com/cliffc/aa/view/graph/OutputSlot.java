...
public class OutputSlot extends Slot {
    ...
    OutputSlot(Figure figure, int wantedIndex) {
    ...
    public v2 posRel() {
        ...
        double gapRatio = gap / (double)(getFigure().getOutputSlots().size() + 1);
        float gapAmount = (float)((getPosition() + 1)*gapRatio);
        return new v2(gapAmount + Figure.getSlotsWidth(Figure.getAllBefore(getFigure().getOutputSlots(), this)) +
                width()/2, Figure.SLOT_START);
    }
