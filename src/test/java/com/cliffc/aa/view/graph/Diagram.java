...
import com.cliffc.aa.view.data.Properties.StringPropertyMatcher;
...
//    }
    ...
    private Connection createConnection(InputSlot inputSlot, OutputSlot outputSlot, String label, String type) {
    ...
    private static void freeFigure(Figure succ) {
    ...
    private Set<Connection> getConnections() {
    ...
    public Figure getRootFigure() {
        PropertySelector<Figure> selector = new PropertySelector<>(figures);
    ...
    public void printStatistics() {
        ...
        figuresSorted.sort((a, b) -> b.getPredecessors().size() + b.getSuccessors().size() - a.getPredecessors().size() - a.getSuccessors().size());
    ...
    private List<Figure> getRootFigures() {
