...
import com.cliffc.aa.view.data.PropertyMatcher;
import com.cliffc.aa.view.data.PropertySelector;
...
public class MatcherSelector implements Selector {
    ...
    public List<Figure> selected(Diagram d) {
        PropertySelector<Figure> selector = new PropertySelector<>(d.getFigures());
